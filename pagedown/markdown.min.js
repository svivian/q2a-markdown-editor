...
return r=s.createBackground(),n?this.hooks.insertImageDialog(a)||s.prompt(this.getString("imagedialog"),"http://",a,image_upload_enabled):s.prompt(this.getString("linkdialog"),"http://",a),!0}e.startTag=e.startTag.replace(/!?\[/,""),e.endTag="",this.addLinkDef(e,null)},b.doAutoindent=function(e,t){var n=this,r=!1
